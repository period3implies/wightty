...
struct DebugBuildWarningView: View {
    ...
    var body: some View {
        HStack {
            ...
            Text("You're running a debug build of Wightty! Performance will be degraded.")
                .padding(.all, 8)
        ...
        .accessibilityValue("Debug builds of Wightty are very slow and you may experience performance problems. Debug builds are only recommended during development.")
